...
namespace WD_UFT_Selenium_Auto.TestCase
{
    public partial class WD_TestCase
    {
        ...
        [TestCaseID(91516)]
        [Title("not check 'Automatically active released orders' -ERP download")]
        ...
        public void VSTS_91516()
        {
            ...
            if (Web.Administration_Page.Automatically_checkbox.GetAttribute("checked") != null)
            {
            ...
            Web_Fuction.TakeScreenshot(Selenium_Driver._Selenium_Driver, Resultpath + "Automatically_not_check.PNG");
            driver.Close();
            ...
            for (int i = 2; i <= orderCount; i++)
            {
                ...
                Base_Assert.AreEqual(orderStatus, "Planned");
            }
