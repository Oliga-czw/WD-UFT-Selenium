...
namespace WD_UFT_Selenium_Auto.TestCase
{
    ...
    {
        [TestCaseID(43371)]
        [Title("Order kitting can not finish if not all pallet or container are scanned")]
        ...
        public void VSTS_43371()
        {
            ...
            WD.mainWindow.GetSnapshot(Resultpath + "not_all_pallet_are_scanned.PNG");
            Base_Assert.IsFalse(WD.mainWindow.SelectAnOrderToKittingFrame.accept.IsEnabled);
