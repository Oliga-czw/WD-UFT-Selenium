...
namespace MES_APEM_UFT_Selenium_Auto.TestCase
{
    public partial class APEM_TestCase
    {
        ...
        public void VSTS_801579()
        {
            ...
            //search order:t_order
            Mobile.OrderProcess_Page.OrderSearch.SendKeys("t_order");
            Thread.Sleep(10000);
            //get order number
            ...
            driver.execute_script("document.getElementsByClassName('table-content scroll-bar full show-navigation desktop-mode')[0].scrollTop = 100000");
            Thread.Sleep(5000);
            Mobile_Fuction.TakeScreenshot(Selenium_Driver._Selenium_Driver, Resultpath + "Orders 520.PNG");
            //get order number
            int Lcount = Mobile.OrderProcess_Page.OrderPhaseTableRows.Count;
            //check order displays 520
            Base_Assert.AreEqual(Lcount, 520, "Orders displays 520.");
