...
namespace MES_APEM_UFT_Selenium_Auto.TestCase
{
    public partial class Mobile_TestCase
    {
        ...
        public void VSTS_997428()
        {
            ...
            MOC_Fuction.PlanFromRPL("FOR_STATUS", ordername, false);
            ...
            try
            {
                ...
                //Base_Assert.AreEqual(Mobile.Consolidated_Page.OrderPhaseTable._Selenium_WebElement.Size.Height, 0);
                Assert.AreEqual(Mobile.Consolidated_Page.OrderPhaseTableRows.Count, PhaseCount - 2);
