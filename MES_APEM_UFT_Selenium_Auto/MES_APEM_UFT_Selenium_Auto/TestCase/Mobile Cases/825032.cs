...
namespace MES_APEM_UFT_Selenium_Auto.TestCase
{
    ...
    {
        [TestCaseID(825032)]
        [Title("UC730129_set 'CANCEL_PENDDING_WORKSTATION_OPER = 0'and the order phase table status auto refresh when order turns invalid")]
        ...
        public void VSTS_825032()
        {
            ...
            try
            {
                ...
                Assert.AreEqual(Mobile.Consolidated_Page.OrderPhaseTableRows.Count, PhaseCount);
                Mobile.Main_Page.Setting.Click();
