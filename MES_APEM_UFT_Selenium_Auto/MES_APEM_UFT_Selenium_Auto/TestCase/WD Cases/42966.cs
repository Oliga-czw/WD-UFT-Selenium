...
namespace MES_APEM_UFT_Selenium_Auto.TestCase
{
    public partial class WD_TestCase
    {
        ...
        [TestCaseID(42966)]
        [Title("Equipment: 1 user is editing the booth information, another user try to delete the booth.")]
        ...
        [TestMethod]
        public void VSTS_42966()
        {
            string Resultpath = Base_Directory.ResultsDir + CaseID+"-";
            string booth1 = "booth1";
            string booth2 = "booth1***";
            ...
            Web_Fuction.login();
            driver.Wait();
            LogStep(@"2. Go to booth and copy");
            Web_Fuction.gotoTab(WDWebTab.equipment);
            Web_Fuction.select_booth(booth1);
            Web.Equipment_Page.booth_copy_row.Click();
            Web.Equipment_Page.booth_description.SendKeys("add");
            ...
            edge.Wait();
            Web_Fuction.gotoTab(WDWebTab.equipment);
            LogStep(@"4.delete booth2 in edge");
            Web_Fuction.delete_booth(booth2);
            Thread.Sleep(1000);
            LogStep(@"5.update the data in chrome");
            edge.SwitchToChrome();
            Web_Fuction.edit_booth(booth2);
