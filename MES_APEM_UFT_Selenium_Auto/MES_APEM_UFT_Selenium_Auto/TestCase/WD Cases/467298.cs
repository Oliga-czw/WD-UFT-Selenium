...
namespace MES_APEM_UFT_Selenium_Auto.TestCase
{
    ...
    {
        [TestCaseID(467298)]
        [Title("Inspired by customer_Deviation -- use 2 scale with different resolution weigh( BOM item weight tolerance 0.1%)")]
        ...
        [TestMethod]
        public void VSTS_467298()
        {
            string Resultpath = Base_Directory.ResultsDir + CaseID+"-";
            string xml1 = "14 aspen wd deviation_467297 bulk load.xml";
            string xml2 = "07 aspen wd orders_467298 bulk load.xml";
            ...
            Thread.Sleep(1000);
            WD.mainWindow.GetSnapshot(Resultpath + "Scale1 insufficient resolution deviation.PNG");
