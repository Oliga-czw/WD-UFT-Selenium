...
namespace MES_APEM_UFT_Selenium_Auto.TestCase
{
    ...
    {
        [TestCaseID(31389)]
        [Title("Order kitting : finish successfully")]
        ...
        public void VSTS_31389()
        {
            ...
            Thread.Sleep(2000);
            Base_Assert.IsTrue(WD.mainWindow.SelectAnOrderToKittingFrame.accept.IsEnabled);
            WD.mainWindow.GetSnapshot(Resultpath + "AcceptedIsEnabled.PNG");
            WD.mainWindow.SelectAnOrderToKittingFrame.accept.Click();
            if (WD.ErrorDialog.IsExist())
            {
                WD.ErrorDialog.OKButton.Click();
            }
